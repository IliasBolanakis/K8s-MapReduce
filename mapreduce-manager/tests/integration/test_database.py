...
async def db_pool(postgres_container):
    ...
    Capacity Override feature, and the 'combiner_filename' for mid-stream optimization.
    """
    ...
    async with pool.acquire() as conn:
        ...
        await conn.execute("""
            CREATE TABLE IF NOT EXISTS public.jobs (
                ...
                combiner_filename VARCHAR(255), -- FIXED: Added Combiner column
                num_reducers INT NOT NULL DEFAULT 3,
                num_mappers INT DEFAULT NULL, 

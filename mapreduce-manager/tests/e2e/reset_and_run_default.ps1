...
# Note: user_id is typically extracted from the JWT token in the new security model,
# but we leave it here if your test endpoint bypasses auth.
...
$payload = @{
    ...
    combiner_filename = "WordCountCombiner.class"; # <--- ADDED COMBINER

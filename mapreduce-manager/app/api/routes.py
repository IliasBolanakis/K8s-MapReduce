...
async def handle_schedule_job(
    ...
    # Combiner is optional, only resolve the path if the payload includes it
    combiner_obj: Optional[str] = f"{user_id_str}/{payload.combiner_filename}" if payload.combiner_filename else None
    ...
    try:
        ...
        try:
            await JobRepository.create_job(
                ...
                combiner_filename=payload.combiner_filename,
                db_pool=db_pool,
        ...
        derived_combiner_class: Optional[str] = payload.combiner_filename.rsplit('.class', 1)[0] if payload.combiner_filename else None
        ...
        try:
            ...
            await TaskPublisher.publish_map_tasks(
                ...
                combiner_obj=combiner_obj,
                combiner_class=derived_combiner_class
            )

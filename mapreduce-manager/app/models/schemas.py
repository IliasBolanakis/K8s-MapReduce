...
class ScheduleJobRequest(BaseModel):
    ...
    combiner_filename: Optional[str] = Field(
        default=None,
        description="The optional filename of the compiled Combiner bytecode (e.g., 'WordCountCombiner.class')."
    )
...
class TaskMessage(BaseModel):
    ...
    # Combiner bytecode metadata (Optional)
    combiner_code_object: Optional[str] = Field(
        default=None,
        description="S3 key for the optional Combiner bytecode."
    )
    combiner_class_name: Optional[str] = Field(
        default=None,
        description="The fully qualified Java Combiner class."
    )

...
class Job(BaseModel):
    ...
    Attributes:
        ...
        reducer_filename (str): The filename of the compiled Java Reducer
            bytecode residing in the user's 'code' directory.
        combiner_filename (Optional[str]): The optional filename of the compiled
            Java Combiner bytecode for local Map-side reduction optimizations.
    ...
    combiner_filename: Optional[str] = Field(default=None)

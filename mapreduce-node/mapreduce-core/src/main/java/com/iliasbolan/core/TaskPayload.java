 ...
 * @param combinerCodeObject The optional MinIO object key for the user's compiled Combiner optimization code.
 * @param combinerClassName  The optional fully qualified name of the user's Combiner class.

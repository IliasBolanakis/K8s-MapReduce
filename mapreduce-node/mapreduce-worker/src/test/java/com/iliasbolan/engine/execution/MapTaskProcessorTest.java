...
class MapTaskProcessorTest {
    ...
    void testProcessSequentially_SmallDataset_DoesNotFork() throws Exception {
        ...
        // FIX: Passed 'null' for the Combiner argument to test the standard pipeline
        MapTaskProcessor processor = new MapTaskProcessor(records, 0, records.size(), dummyWordCountMapper, null, mockPartitioner);
